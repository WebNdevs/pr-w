  ...
  const fetchCampaignVideo = async () => {
    try {
      ...
      const response = await fetch(
        `http://localhost:8000/api/public/${brand_username}/${campaign_name}`
      );
      ...
      <div className="relative w-full h-screen flex flex-col items-center">
        ...
        <div className="relative w-full max-w-4xl flex-grow">
          <video
            ...
            poster={videoData.thumbnail_path ? `http://localhost:8000/${videoData.thumbnail_path}` : undefined}
            ...
            playsInline
          >
            <source src={`http://localhost:8000/${videoData.file_path}`} type="video/mp4" />
